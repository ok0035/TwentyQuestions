...
//        db.execSQL("CREATE TABLE IF NOT EXISTS User (PKey integer(8) NOT NULL, ID varchar(50), SNSAccessToken varchar(1500), Password varchar(255), LoginType integer(1) DEFAULT 0 NOT NULL, NickName varchar(20) NOT NULL, Phone varchar(15), Gender integer(1) NOT NULL, Birthday date NOT NULL, Longitude double(10), Latitude double(10), ConditionMessage varchar(200), Introduction varchar(200), IsVerification boolean DEFAULT '0', Status tinyint(3) DEFAULT 1, LatestLogin timestamp, UDID varchar(50), DeviceType integer(1), DeviceName varchar(100), OS varchar(200), CreatedDate timestamp NOT NULL, UpdatedDate timestamp NOT NULL);");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS Letter (PKey integer(8) NOT NULL, Sender integer(8) NOT NULL, Receiver integer(8) NOT NULL, TableName varchar(50), TablePKey integer(8), IsLock boolean DEFAULT '0' NOT NULL, IsRead boolean DEFAULT '0', Type integer(1) DEFAULT 0 NOT NULL, Title varchar(100) NOT NULL, Content text, CreatedDate timestamp NOT NULL, UpdatedDate timestamp NOT NULL, IsReaded boolean DEFAULT '0');");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS RightAnswerList (PKey integer(8) NOT NULL, TwentyQuestionsPKey integer(8) NOT NULL, Guesser integer(8), Answerer integer(8), Guess varchar(255) NOT NULL, Answer text NOT NULL, IsRight integer(1) DEFAULT 0 NOT NULL, Status integer(1) DEFAULT 0 NOT NULL, CreatedDate timestamp NOT NULL, UpdatedDate timestamp NOT NULL);");
